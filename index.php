		...
		<table  border="5" width="500" cellspacing="0" class="tablo">
			<tr>
				<td align="center">
						...
						<h1 class="anabaslik">Eren Sürül</h1>
			...
			<tr>
				...
				<td>
					...
					<div></div>
					<textarea name="yemektarif" rows="10" cols="29" placeholder="Yemek Tarifini Yazın" style="margin-left: 22px;" class="txtarea"></textarea>
				</td>
			</tr>
			<tr>
				<td align="center"> 
